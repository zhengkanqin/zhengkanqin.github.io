const ap = new APlayer({
    container: document.getElementById('musicBox'),
    order: 'random',
    preload: 'auto',
    listMaxHeight: '336px',
    volume: '0.5',
...
setInterval(function () {
    $("#footer").html("<span class='lrc-show'><i class='iconfont icon-music'></i> " + $(".aplayer-lrc-current").text() + " <i class='iconfont icon-music'></i></span>");
}, 500);
...
ap.on('play', function () {
    ...
    // transforom the img of the music to stop
